%%
%% This is file for WindMill study group's minutes of meeting,
%% ----------------------------------------------------------------------
%% 
...
\setcommittee{Meeting Topic Here}

\setmembers{
  \chair{Chair of meeting},
  ESR1 name,
  ESR2 name,
  ESR3 name
}
...
%present or absent ESRs (could remove it if you like)
\setpresent{
  \chair{ESR chairing},
  ESR1,
  ESR2
...
\absent{ESR_absent name \textit{(sabbatical)}}

%if any advisor or someone else in present such as Michael
\alsopresent{NAME of the person}
